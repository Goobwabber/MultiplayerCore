...
namespace MultiplayerCore.Helpers
{
    public class ZipExtractor
    {
        ...
        private static char[] _invalidTrailingPathChars = new char[] { ' ', '.', '-' };
        ...
        /// <returns></returns>
        public async Task<ZipExtractResult> ExtractZip(Stream zipStream, string extractDirectory, bool overwriteTarget = true, string? sourcePath = null)
        {
            if (zipStream == null)
...
#pragma warning restore CA1031 // Do not catch general exception types
        ...
        public string GetValidPath(string extractDirectory, int longestEntryName, int padding = 0)
        {
            ...
            return extractDirectory.TrimEnd(_invalidTrailingPathChars);
        }
        ...
        /// <returns></returns>
        public async Task<bool> WaitUntil(Func<bool> condition, int milliseconds, CancellationToken cancellationToken)
        {
